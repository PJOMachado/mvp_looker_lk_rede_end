- dashboard: escola_turma
  title: ESCOLA TURMA
  layout: newspaper
  preferred_viewer: dashboards-next
  crossfilter_enabled: true
  description: ''
  preferred_slug: E6IWzLkec6ysdky2QGJohX
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: ESCOLA TURMAS
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", d_turmas_end.turma, d_turmas_end.total_alunos,
      f_medidas_end.presenca, faltas, f_medidas_end.total_aulas, f_medidas_end.total_amparo,
      d_turmas_end.escola, d_turmas_end.nomemunicipio40]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
