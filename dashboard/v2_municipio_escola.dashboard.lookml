- dashboard: municipio_escola
  title: MUNICIPIO ESCOLA
  layout: newspaper
  preferred_viewer: dashboards-next
  crossfilter_enabled: true
  description: ''
  preferred_slug: z2nWMGPQlH0xhfaYsO8s1a
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: MUNICIPAL ESCOLA
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", d_turmas_end.escola, rank, d_turmas_end.total_alunos,
      f_medidas_end.presenca, faltas, f_medidas_end.total_aulas, f_medidas_end.total_amparo,
      d_turmas_end.nomemunicipio40]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
  ...
  - name: " (4)"
    ...
    body_text: "<div style=\"background-color: rgba(35, 61, 77, 0.1); padding: 10px;\
      ...
      \ 15px;\">REDE</a>\n    <a href=\"/embed/dashboards/32?\" style=\"background-color:\
      ...
      \ ease; margin-right: 15px;\">ESCOLA TURMA</a>\n    <a href=\"/embed/dashboards/30\"\
      ...
      \ background-color 0.3s ease;\">TURMA</a>\n</div>\n\n<script>\n  document.querySelectorAll('a').forEach(button\
