- dashboard: rede
  ...
  description: ''
  preferred_slug: GAQlCk0nXg7SfXgttoFiEj
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: REDE MUNICIPAL
    ...
    column_order: ["$$$_row_numbers_$$$", d_turmas_end.nomemunicipio40, rank, d_turmas_end.total_alunos,
      f_medidas_end.total_aulas, f_medidas_end.total_amparo, f_medidas_end.presenca,
      faltas]
    show_totals: true
  ...
  - title: 'SÉRIE HISTÓRICA: (%) PRESENÇA SEMANAL'
    ...
    width: 24
    height: 6
  - title: MUNICIPAL ESCOLA
    name: MUNICIPAL ESCOLA
    model: mvp_looker_lk_rede_end
    explore: f_medidas_end
    type: looker_grid
    fields: [d_turmas_end.nomemunicipio40, f_medidas_end.presenca, f_medidas_end.total_amparo,
      f_medidas_end.total_aulas, d_turmas_end.total_alunos, d_turmas_end.escola]
    filters: {}
    sorts: [f_medidas_end.presenca desc]
    limit: 500
    column_limit: 50
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", d_turmas_end.nomemunicipio40, d_turmas_end.escola,
      rank, d_turmas_end.total_alunos, f_medidas_end.total_aulas, f_medidas_end.total_amparo,
      f_medidas_end.presenca, faltas]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
  ...
  - title: ESCOLA TURMAS
    ...
    type: looker_grid
    fields: [d_turmas_end.nomemunicipio40, f_medidas_end.presenca, f_medidas_end.total_amparo,
      f_medidas_end.total_aulas, d_turmas_end.total_alunos, d_turmas_end.escola, d_turmas_end.turma]
    sorts: [f_medidas_end.presenca desc, d_turmas_end.turma]
    limit: 500
    column_limit: 50
    total: true
    dynamic_fields:
    ...
    show_sql_query_menu_options: false
    column_order: ["$$$_row_numbers_$$$", d_turmas_end.nomemunicipio40, d_turmas_end.escola,
      d_turmas_end.turma, rank, d_turmas_end.total_alunos, f_medidas_end.total_aulas,
      f_medidas_end.total_amparo, f_medidas_end.presenca, faltas]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 75
  ...
  - type: button
    name: button_185
    rich_content_json: '{"text":"DETALHE POR TURMA","description":"","newTab":false,"alignment":"center","size":"medium","style":"FILLED","color":"#233D4D","href":"/dashboards/28?&fMUNICÍPIO={{
      /dashboards/23?MUNICÍPIO= {{ value }}}}"}'
    row: 28
    col: 0
    width: 24
    height: 1
